                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="orders.aspx">Orders</a>
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="GridViewOrder" Width="100%" CssClass="table table-striped table-bordered table-hover" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" DataKeyNames="order_id" AllowPaging="True" OnPageIndexChanging="GridViewOrder_PageIndexChanging" ShowFooter="True" FooterStyle-BackColor="White">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="order_status" HeaderText="Order Status" HeaderStyle-CssClass="visible-xs" ItemStyle-CssClass="visible-xs">
                                        <HeaderStyle CssClass="visible-xs"></HeaderStyle>
                                        <ItemStyle CssClass="visible-xs"></ItemStyle>
                                    </asp:BoundField>

                                    <asp:BoundField DataField="order_date" HeaderText="Order Date" DataFormatString="{0:MM/dd/yyyy}" HeaderStyle-CssClass="visible-xs" ItemStyle-CssClass="visible-xs">
                                        <HeaderStyle CssClass="visible-xs"></HeaderStyle>
                                        <ItemStyle CssClass="visible-xs"></ItemStyle>
                                    </asp:BoundField>

                                    <asp:BoundField DataField="approved_date" HeaderText="Approved Date" DataFormatString="{0:MM/dd/yyyy}" ItemStyle-CssClass="visible-md" HeaderStyle-CssClass="visible-md">
                                        <HeaderStyle CssClass="visible-md"></HeaderStyle>
                                        <ItemStyle CssClass="visible-md"></ItemStyle>
                                    </asp:BoundField>
                                    
                                    <asp:BoundField DataField="shipping_date" HeaderText="Shipping Date" DataFormatString="{0:MM/dd/yyyy}" ItemStyle-CssClass="visible-lg" HeaderStyle-CssClass="visible-lg">
